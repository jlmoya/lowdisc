...
// The current output message function
void (* sobol_outputmsg_function)(string msg) = NULL;

// Displays the given message with the current message function
void sobol_outputmsg ( string msg ) {
      if (sobol_outputmsg_function!=NULL) {
	      (*sobol_outputmsg_function)(msg);
      }
}

// TODO : use this function in the client code
// Configure the message function
void sobol_outputmsg_setfunction ( void (* f)(string msg) ) {
      sobol_outputmsg_function = f;
}
...
//
  ...
  ostringstream msg;
  msg << "Nisp - i4_sobol" << endl;
  msg << "  *SEED = " << *seed << "  L = " << l << endl;
  sobol_outputmsg(msg.str());
  /*
  cout << "  *SEED = " << *seed << "  L = " << l << "\n";
  */
...
//
    if ( dim_num < 1 || DIM_MAX2 < dim_num )
    {
      ostringstream msg;
      msg << "ERROR **********************" << endl;
      msg << "Nisp(i8_sobol) - Fatal Error" << endl;
      msg << "  The spatial dimension DIM_NUM should satisfy"<<endl;
      msg << "    1 <= DIM_NUM <= " << DIM_MAX2 << endl;
      msg << "  But this input value is DIM_NUM = " << dim_num << endl;
      msg << "****************************" << endl;
...
# define TIME_SIZE 40
  ...
  ostringstream msg;
  msg << "Nisp - timestamp" << endl;
  msg << time_buffer << endl;
  sobol_outputmsg(msg.str());
  /*
  cout << time_buffer << "\n";
  */
