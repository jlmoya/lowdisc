...
\end{itemize}
      ...
      We consider here the Niederreiter sequence in base 2 
	  (see table II in \cite{Niederreiter1988}).
...
\end{itemize}
      ...
      sequences.
      This is the table 4.2 in \cite{Thiemard2000} (Section 4.6 "Les (t,s)-suites 
...
for which the $i$-th side has length equal to $1/b_i$, where 
...
This is why in the following script, we consider $2^4=16$ 
...
and plot elementary intervals with volume $1/8$ : there are two points by interval.
...
Some of the pictures in the section \ref{sec-tmsnetfaure} can be seen 
in \cite{Seng1997}.
