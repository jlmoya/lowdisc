...
\section{Definitions}
      ...
      with integers $a_i$ and $d$ such that $d\geq 0$ and $0\leq a_i < b^{d_i}$,
      for $i=1,2,...,s$.
...
$$    
      ...
      The following script computes all base 2 
	  elementary intervals with volume $1/2^3=1/8$, 
...
\end{figure}
	  ...
	  the fraction of points in the elementary intervals. 
      ...
      with 1 point by elementary interval.
...
\item Niederreiter sequences are (0,s)-sequences defined for any base b,
          where b is a power of a prime.
\end{itemize}

    
      The following table presents the quality parameters t of binary (t,s)-sequences.
      For Sobol sequence, this is the table in section 3.4 of [6], 
	  extended with personal computations.
      We consider here the Niederreiter sequence in base 2 (see table II in [5]).
...
\section{Discrepancy}
      ...
      Definition: multi-dimensional interval. The set P is an interval of $[0,1]^s$
      if:
$$
...
$$    
      ...
      Moreover, $\lambda(P)$ is the volume of P:
$$
...
\section{Estimate of the mean by a low discrepancy sequence}
      ...
      Let f from $[0,1]^s$ to R be a function where
      $V(f)$, the variation in the sense of Hardy and Krause, is bounded, therefore,
      for any sequence of n points x(n), we have
$$
        \left|\frac{1}{n} \sum_{i=1}^n f(x^{(i)} - \int_{[0,1]^s} f(x)dx \right|
        \leq V(f) D^\star_n(x).
$$    

    
      Theorem (Niederreiter):
...
\end{itemize}
      ...
      The following table presents the constant C(b,s,t) for several
      sequences.
      This is the table 4.2 in [1].
...
h.isoview="off";
   \end{lstlisting}
      ...
      <inlinemediaobject>
        <imageobject>
          <imagedata
          fileref ="../figures/halton-n12.png"
          align ="center"
          valign ="middle"
			/>
        </imageobject>
...
\section{Faure sequence}
      ...
      there are $b^t=1$ points for any elementary interval of volume 
      $1/b^m=1/16$.
    
    
      Plot $2^4=16$ Faure points (insert zero) and
      plot elementary intervals with volume $1/2^4=1/16$
...
\end{figure}
      ...
      Plot $2^4=16$ Faure points (insert zero) and
      plot elementary intervals with volume $1/2^3=1/8$:
...
\end{figure}
      ...
      Plot 16 Faure points and plot elementary intervals
      with volume $1/8$ : there are two points by interval.
...
\section{Niederreiter base 2 sequence}
      ...
      Plot elementary intervals with Niederreiter (base 2) points (insert zero)
...
lowdisc_plotbmbox(2,4,u);
    \end{lstlisting}
      ...
      <inlinemediaobject>
        <imageobject>
          <imagedata
          fileref ="../figures/nieder-n32-v16.png"
          align ="center"
          valign ="middle"
			/>
        </imageobject>
...
\end{lstlisting}
    ...
    <inlinemediaobject>
      <imageobject>
        <imagedata
        fileref ="../figures/nieder-n32-v8.png"
        align ="center"
        valign ="middle"
			/>
      </imageobject>
...
lowdisc_plotbmbox(2,4,u);
    \end{lstlisting}
      ...
      <inlinemediaobject>
        <imageobject>
          <imagedata
          fileref ="../figures/sobol-n16-v16.png"
          align ="center"
          valign ="middle"
			/>
        </imageobject>
...
xtitle("Sobol, Volume=1/32, 64 Points");
    \end{lstlisting}
      ...
      <inlinemediaobject>
        <imageobject>
          <imagedata
          fileref ="../figures/sobol-n64-v32.png"
          align ="center"
          valign ="middle"
			/>
        </imageobject>
...
h.isoview="off";
    \end{lstlisting}
      ...
      <inlinemediaobject>
        <imageobject>
          <imagedata
          fileref ="../figures/halton-leaped-s2.png"
          align ="center"
          valign ="middle"
			/>
        </imageobject>
...
lowdisc_plotbmbox(2,4,u);
    \end{lstlisting}
      ...
      <inlinemediaobject>
        <imageobject>
          <imagedata
          fileref ="../figures/faure-leaped-s2.png"
          align ="center"
          valign ="middle"
			/>
        </imageobject>
