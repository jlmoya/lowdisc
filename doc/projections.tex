...
% http://creativecommons.org/licenses/by-sa/3.0/
    ...
    \chapter{Projections}
	  ...
	  for small dimensions ($s<25$), the Faure sequence 
	  is better for large dimensions ($s>25$) and that the scrambled 
	  Halton sequence is generally better than a classical Halton 
	  sequence.
...
\section{Halton Sequence}
      ...
      as in "On the optimal Halton sequence",
      Chi, Mascagnib, Warnock
...
\end{figure}
      ...
      as suggested by Kocis and Whiten \cite{Kocis:1997:CIL:264029.264064}.
...
\end{figure}
      ...
      There are 41*41=1681 intervals, each with volume 1/1681. 
...
\end{figure}
      ...
      Since the number of points is 300 which is much smaller than 41*41=1681, 
...
\end{figure}
      ...
      Following Kocis and Whithen \cite{Kocis:1997:CIL:264029.264064}, 
...
xtitle(msprintf("Volume=1/2^%d, %d Points",m,N),"X5","X22")
//
subplot(2,1,2);
m=13;
N=b^m;
...
\section{Two-dimensionnal correlations with increasing dimensions}
