...
//    0 < NONZER < 2.
//
function [ pc_deg, pc, v ] = lowdisc_niedercalcv2 ( maxv, px_deg, px, add, mul, sub, b_deg, b )
  arbit = 1;
  nonzer = 1;
  e = px_deg;
//
...
//  don't forget this if you use them later!
//
  [ pc_deg, pc ] = lowdisc_niederplymul2 ( add, mul, px_deg, px, b_deg, b );
  m = pc_deg;
//
